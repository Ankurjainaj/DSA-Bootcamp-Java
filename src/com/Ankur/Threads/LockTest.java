...
class TestResource {
    ...
    // displayQueueLock is created to make displayQueueLock thread safe.
    // When T1 acquires lock on testresource(o1) object displayRecord method
    // T2 has to wait for lock to be released by T1 on testresource(o1) object displayRecord method.
    // But T3, can execute readRecord method with out waiting for lock
    ...
    // displayRecord uses displayQueueLock to achieve thread safety.
